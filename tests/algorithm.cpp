...
public:
    TEST_METHOD(non_modifying_sequence) {
        ...
        ASSERT(plastic::find_last(e.begin(), e.end(), 0).begin() == e.end());
        ASSERT(plastic::find_last(b.begin(), b.end(), 5).begin() == b.end());
        ASSERT(plastic::find_last(c.begin(), c.end(), 2).begin() == c.begin() + 3);

        ASSERT(plastic::find_last_if(e.begin(), e.end(), [](int x) { return x == 0; }).begin() == e.end());
        ASSERT(plastic::find_last_if(a.begin(), a.end(), [](int x) { return x % 2 == 0; }).begin() == a.end());
        ASSERT(plastic::find_last_if(c.begin(), c.end(), [](int x) { return x < 3; }).begin() == c.begin() + 4);

        ASSERT(plastic::find_last_if_not(e.begin(), e.end(), [](int x) { return x != 0; }).begin() == e.end());
        ASSERT(plastic::find_last_if_not(c.begin(), c.end(), [](int x) { return x == 1; }).begin() == c.begin() + 3);
        ASSERT(plastic::find_last_if_not(d.begin(), d.end(), [](int x) { return x == 5; }).begin() == d.end());
        ...
        ASSERT(plastic::equal(a.begin(), a.end(), b.begin(), b.end(), {}, [](int x) { return x + 1; }) == true);

        ASSERT(plastic::is_permutation(e.begin(), e.end(), e.begin(), e.end()) == true);
        x = { 9, 7, 5, 3, 1 };
        ASSERT(plastic::is_permutation(a.begin(), a.end(), x.begin(), x.end()) == true);
        x = { 1, 1, 3, 5, 7 };
        ASSERT(plastic::is_permutation(a.begin(), a.end(), x.begin(), x.end()) == false);
        x = { 1, 3, 5, 7, 9, 11 };
        ASSERT(plastic::is_permutation(a.begin(), a.end(), x.begin(), x.end()) == false);
    ...
    TEST_METHOD(minimun_and_maximum) {
    ...
    TEST_METHOD(lexicographical_comparison) {
