...
namespace algorithm_test {
	...
	namespace all_of_any_of_none_of {
	...
	namespace find_find_if_find_if_not {
	...
	namespace replace_copy_replace_copy_if {
	...
	namespace remove_copy_remove_copy_if {
	...
	namespace shift_left_shift_right {
	...
	namespace is_sorted_is_sorted_until {
...
2, 4, 6, 4, 5
		...
		test("all_of/any_of/none_of", all_of_any_of_none_of::run, R"(
...
At least one number is divisible by 7
		...
		test("find/find_if/find_if_not", find_find_if_find_if_not::run, R"(
v contains 3
...
The last element in the non-decreasing subsequence is at 7, *i2 = 41
		...
		test("count/count_if", count_count_if::run, R"(
...
Has 2 consecutive zeros: true
		...
		test("copy/copy_if", copy_copy_if::run, R"(
...
ordinals: 144 138 152 152 158
		...
		test("replace/replace_if", replace_replace_if::run, R"(
5 7 4 2 88 6 1 9 0 3
5 7 55 55 88 6 55 9 55 55
(4,2) (4,2)
)");

		test("replace_copy/replace_copy_if", replace_copy_replace_copy_if::run, R"(
3 1 4 1 5 9 2 6 5 
3 1 4 1 5 0 2 0 5 
(1,3) (2,4) (3,5) 
(4,2) (4,2) (3,5)
...
v: 0 1 2 3 4
		...
		test("remove/remove_if", remove_remove_if::run, R"(
Textwithsomespaces size: 23
Textwithsomespaces size: 18
Textwithsomewhitespaces
)");

		test("remove_copy/remove_copy_if", remove_copy_remove_copy_if::run, R"(
...
1 2 3 4 5
		...
		test("shift_left/shift_right", shift_left_shift_right::run, R"(
...
. . 4 5 6 7 .   . . ¦Ä ¦Å ¦Æ ¦Ç .
		...
		test("shuffle/sample", shuffle_sample::run, R"(
No Compile Error.
)");
...
The return value is the iterator to 15
		...
		test("is_sorted/is_sorted_until", is_sorted_is_sorted_until::run, R"(
Test End.
)");
